      ...
      <div className="w-full max-w-4xl">
        ...
        <div className="bg-stone-800/50 p-8 md:p-10 rounded-xl shadow-2xl border border-amber-700/30 space-y-8 font-serif text-lg leading-relaxed text-stone-300">
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <p>
              En <span className="text-amber-300 font-semibold">Mundo Tinta</span>, somos más que una simple librería online; somos un portal a universos ilimitados, forjados en las llamas de la imaginación de autores de ciencia ficción y fantasía. 
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-8">
            ...
            <p>
              ...
              Seleccionamos cuidadosamente cada título, buscando tanto clásicos atemporales como las voces más innovadoras y prometedoras del género.
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <p>
              Queremos que <span className="text-amber-300 font-semibold">Mundo Tinta</span> sea tu compañero de viaje en cada nueva lectura. Un lugar donde puedas descubrir tu próxima obsesión literaria, conectar con otros aficionados y celebrar el poder sin límites de la narrativa fantástica. 
